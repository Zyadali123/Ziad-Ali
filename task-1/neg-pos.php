...
<html lang="en">
    <head>
        ...
        <title>negativ or positive number</title>
    </head>
    <body>
        <div class="container">
            <div class="row">
                <div class="col-6 m-auto mt-5 p-5">
                    <h3 class="text-center text-success">negativ or positive number</h3>
                    <form method="POST">
                        <div class="mb-3">
                            <label for="number" class="form-label">intre number</label>
