        ...
        <div class="container">
            <div class="row">
                <div class="col-6 m-auto mt-5 p-5">
                    <h3 class="text-center text-success">your grade</h3>
                    <form method="POST">
                        <div class="mb-3">
                    ...
                    <div class="alert alert-success mt-3 col-11 m-auto" role="alert">
                        your precentage is : <b> <?php if(isset($percentage)){echo $percentage . " %";}  ?></b> 
                        <br>
                        <br>
                        the gread is : <b><?php if(isset($grade)){echo $grade;}  ?></b>
                    </div>
                </div>
            </div>
        </div>
