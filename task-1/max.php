        ...
        <div class="container">
            <div class="row">
                <div class="col-6 m-auto mt-5 p-5">
                    <h3 class="text-center text-success">max & min number</h3>
                    <form method="POST">
                        <div class="mb-3">
                            <label for="num-1" class="form-label">Number1</label>
                            <input type="number" name="num-1" class="form-control" id="num-1">
                        </div>
                        <div class="mb-3">
                            <label for="num-2" class="form-label">Number2</label>
                            <input type="number" name="num-2" class="form-control" id="num-2">
                        </div>
                        <div class="mb-3">
                            <label for="num-3" class="form-label">Number3</label>
                    ...
                    <div class="alert alert-success mt-3 col-11 m-auto" role="alert">
                        max number : <b> <?php if(isset($max)){echo $max;}  ?></b> 
                        <br>
                        <br>
                        min number : <b><?php if(isset($min)){echo $min;}  ?></b>
                    </div>
                </div>
            </div>
        </div>
