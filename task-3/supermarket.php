        ...
        <div class="row">
            <div class="col-5">
                <form action="#" method="POST" class="mt-5">
                    ...
                    <div class="mb-3">
                        <label for="number-of-varieties" class="form-label">Number of varieties</label>
                        <input type="number" name="number-of-varieties" value="<?php echo $number_of_varieties; ?>" class="form-control" id="number-of-varieties">
                    </div>
                    <button type="submit" name="submit-info-user" class="btn btn-primary col-12">Ok</button>
                    <hr>
                    <?php echo $table ?? ''; ?>
                    <hr>
